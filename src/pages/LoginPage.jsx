...
import { loginOfficer } from "../apis/officer";
...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    if (!mobile || !password) {
      return toast.error("Please enter both mobile number and password");
    }

    setLoading(true);
    try {
      const data = await loginOfficer(mobile, password);
      const { token, officer } = data;
      login(officer, token);
  ...
  return (
    <>
      <PageMeta
        title="Login | Officer Portal"
        description="Login to your Redressal Officer Portal"
      />
        ...
        <div className="relative w-full max-w-[420px]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Sign in to your officer portal
            </p>
          </div>
